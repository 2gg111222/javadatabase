...
public class 반환값받아오기 {
	public static void main(String[] args) {
		...
		re.add2(); //불꺼!
		//int result = re.add(); // 반환값 없어서 오류 add(반환값 들어갈 자리);
		
		
		int result1 = re.add(200, 100); //int 300
		System.out.println("더한 값은 " + result1);
		
		//String data2 =JOptionPane.showInputDialog("message 입력");
		//입력값 받아옴
		
		//String data3 =JOptionPane.showMessageDialog( null, "출력"); 
		// 받아올 값 없음, 에러
		...
		result9.set(0, "양파"); //0번 인덱스의 값 앙파로 변경
